...
const PRINCIPLES = [
  {
    icon: ShieldCheck,
    title: "그룹으로만 만납니다",
    body: "1:1 화상 매칭은 제공하지 않습니다. 합석 룸은 최소 4명으로 시작하며, 인원이 기준 아래로 떨어지면 세션이 일시 정지되고 참가자는 대기 라운지로 돌아갑니다.",
  },
  {
    icon: Eye,
    ...
    <Container className="py-20 sm:py-24">
      ...
      <section id="reveal" className="mt-20 scroll-mt-20 max-w-3xl">
        ...
        <ul className="mt-6 space-y-3 text-[0.9375rem] leading-relaxed text-muted">
          <li>· 얼굴 공개는 두 사람이 모두 동의해야 이루어집니다.</li>
          <li>
            · 공개는 요청을 주고받은 두 사람 사이에서만 적용되며, 같은 룸의 다른
            참가자에게는 계속 마스크가 유지됩니다.
          </li>
          <li>
            · 어느 한쪽이 마스크를 복구하면 양방향 모두 즉시 마스크 상태로
            돌아갑니다.
          </li>
          <li>
            · 차단, 신고, 퇴장, 세션 종료 시 얼굴 공개는 즉시 종료됩니다.
          </li>
          <li>
            · 거절해도 상대에게 거절 사유가 표시되지 않으며, 재요청은 제한됩니다.
          </li>
        </ul>
      </section>
      ...
      <section id="recording" className="mt-16 scroll-mt-20 max-w-3xl">
        ...
        <p className="mt-4 text-[0.9375rem] leading-relaxed text-faint">
          ...
          차단할 수 없습니다. 그래서 마스크 기본 착용, 상호 동의 기반 공개, 동적
      ...
      <section className="mt-16 max-w-3xl">
        ...
        <ol className="mt-6 space-y-3 text-[0.9375rem] leading-relaxed text-muted">
          ...
          <li>
            3. 신고와 동시에 해당 참가자를 차단할 수 있으며, 차단 시 얼굴 공개는
            즉시 해제됩니다.
          </li>
          <li>
