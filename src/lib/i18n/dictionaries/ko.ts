...
export const ko = {
  ...
  site: {
    ...
    description:
      "프로필을 넘기는 대신 대화로 만나는 성인 전용 온라인 소셜 클럽. 친구와 함께 그룹으로 입장해, 이동도 대기도 없이 새로운 사람들과 이야기합니다.",
  ...
  entry: {
    ...
    errors: {
      ...
      pass_required: "라운지에 입장하려면 이용권이 필요합니다. 테스트 이용권을 받거나 선물 코드를 등록해 주세요.",
    },
  },
  ...
  safety: {
    metaTitle: "안전 센터",
    metaDescription:
      "ClubOn의 안전 원칙, 촬영·녹화 금지 정책과 신고 절차 안내.",
    eyebrow: "안전 센터",
    ...
    p2Title: "카메라와 마이크는 내가 정합니다",
    p2Body:
      "카메라와 마이크는 언제든 직접 끌 수 있고, 끈 상태로도 대화에 계속 참여할 수 있습니다. 모더레이션 조치로 영상이 제한되면 블러 처리되거나 아바타로 대체됩니다.",
    p3Title: "언제든 나가고, 신고할 수 있습니다",
    p3Body:
      "룸 안에서 신고와 차단은 항상 한 번의 조작으로 가능합니다. 차단하면 이후 매칭에서도 해당 회원과 다시 만나지 않습니다.",
    p4Title: "촬영과 녹화는 금지됩니다",
    p4Body:
      "가입 시와 룸 입장 전 두 차례 확인을 받습니다. 화면에는 사용자 식별자와 시각이 포함된 워터마크가 표시됩니다.",

    recordingTitle: "촬영·녹화 금지 정책",
    recordingBody:
      "다른 참가자의 영상, 음성, 개인정보를 캡처·녹화·촬영하거나 공유하는 행위는 금지됩니다. 위반 시 영구 이용정지 및 관련 법률에 따른 법적 책임이 따를 수 있습니다.",
    recordingLimits:
      "플랫폼은 모든 스크린샷이나 외부 기기를 이용한 촬영을 기술적으로 완전히 차단할 수 없습니다. 그래서 동적 워터마크, 반복 확인 절차, 신고와 제재를 함께 운영합니다.",

    reportTitle: "신고 절차",
    report1: "룸 안에서 해당 참가자의 신고 버튼을 선택합니다.",
    report2: "사유를 고르고 필요하면 상황을 설명합니다.",
    report3:
      "신고와 동시에 해당 참가자를 차단할 수 있으며, 차단하면 그 참가자의 메시지가 더 이상 보이지 않습니다.",
  ...
  landing: {
    ...
    uspHeadline: "오늘 밤, 새로운 사람들과 연결되는",
    uspHeadlineAccent: "가장 특별한 방법",
    uspSub1: "이동도, 긴 대기도 필요 없는 프라이빗 온라인 라운지.",
    uspSub2: "혼자 또는 친구와 함께 입장하고 편안하게 새로운 인연을 만나보세요.",
    uspCta: "라운지 둘러보기",
    uspSignature: "CLUB ON — 온라인 소셜 라운지",
    ...
    howEyebrow: "이용 방식",
    howTitle:
      "불금이 아니어도, 내가 사는 지역이 아니어도, 친구들과 캠핑가서도, 해변에서도, 내가 있는 그곳이 바로 클럽 라운지로 변하는 곳",
    howBody:
      "ClubOn은 무작위 화상 채팅이 아닙니다. 그룹으로 입장하며, 매칭은 양측 합의로만 성사됩니다.",
    step1Title: "성인 인증 후 입장",
    step1Body: "생년월일 확인과 개별 동의 절차를 거쳐 회원으로 등록합니다.",
    step2Title: "테이블 구성",
    step2Body:
      "1~4명으로 테이블을 만듭니다. 혼자여도 바로 상대 라운지를 찾을 수 있습니다.",
    ...
    step5Title: "합석 룸에서 대화",
    step5Body:
      "라운지끼리 화면과 소리를 함께 나눕니다. 카메라와 마이크는 언제든 직접 끌 수 있습니다.",
    step6Title: "정해진 시간만큼",
    step6Body:
      "한 자리는 30분입니다. 대화가 잘 이어지면 결제로 시간을 늘릴 수 있습니다.",
    ...
    safetyNote:
      "모더레이션은 자동 검사와 사람의 검토를 함께 사용하지만 모든 위반을 완벽하게 걸러낸다고 보장하지 않습니다. 또한 플랫폼은 모든 스크린샷과 외부 촬영을 기술적으로 차단할 수 없습니다. 그래서 워터마크와 신고 절차를 함께 운영합니다.",

    hoursTitle: "연중무휴 24시간 운영",
    hoursBody: "전 세계 어디서든 시차와 관계없이 언제든 이용할 수 있습니다.",
    hoursCta: "먼저 가입해 두기",
  ...
  roomChat: {
    system: "시스템",
    opened:
      "두 라운지가 합석했습니다. 오늘 자리는 {waiter} 매니저가 안내합니다. 편안하게 인사부터 나눠 보세요.",
    noRecording:
  ...
  room: {
    ...
    myLounge: "우리 라운지",
    otherLoungeName: "상대 라운지",
    alsoHere: "함께 있는 회원",
    blockedTag: "차단됨",
    audienceNote:
      "이 라운지의 화면과 소리는 방에 놓인 기기 한 대가 맡습니다. 회의실 카메라처럼 방마다 하나씩만 연결되며, 이 화면에서는 채팅과 남은 시간을 씁니다.",
    audienceControls:
      "마이크와 카메라는 이 라운지의 기기에서 조작합니다. 같은 방에서 마이크를 여러 개 열면 소리가 울립니다.",
    ...
    reportBlockToo:
      "이 회원을 차단합니다. 차단하면 상대의 메시지와 영상이 더 이상 보이지 않습니다.",
    reportCancel: "취소",
    reportSubmit: "신고 접수",
    reportPending: "접수 중…",
    ...
    videoError: "화상 연결에 실패했습니다. 채팅은 그대로 이어집니다.",
  ...
  waiters: {
    ...
    dohyun: {
      ...
      epithet: "20대 매칭 전문",
      outfit: "클래식 블랙타이 턱시도",
      tagline: "답장 속도보다 빠르게, 요즘 케미부터 잡습니다.",
    ...
    ian: {
      ...
      epithet: "30대 매칭 전문",
      outfit: "쓰리피스 테일러드 수트",
      tagline: "일 얘기는 문밖에. 센스와 여유가 맞는 둘을 붙입니다.",
    ...
    jaeha: {
      ...
      epithet: "40대 매칭 전문",
      outfit: "니트 · 슬랙스 캐주얼",
      tagline: "눈치게임은 짧게, 통하는 이야기는 길게 갑니다.",
    ...
    taeo: {
      ...
      tagline: "재미도 내공입니다. 잘 놀 줄 아는 어른끼리 모십니다.",
    ...
    sunwoo: {
      name: "세린",
      epithet: "글로벌 친구 매칭 전문",
      outfit: "벨벳 스모킹 재킷",
      tagline: "국경은 넘고 번역기 어색함은 제가 치웁니다.",
    ...
    seojun: {
      ...
      epithet: "수다 폭발 전문",
      outfit: "화이트 디너 재킷",
      tagline: "정적 3초면 출동. 이야기 폭죽에 불을 붙입니다.",
    ...
    yujin: {
      ...
      epithet: "낯가림 구조대",
      outfit: "미니멀 올블랙 테일러드",
      tagline: "낯가림도 취향입니다. 말문만 살짝 열어드려요.",
    ...
    haram: {
      ...
      epithet: "취향 저격 전문",
      outfit: "브리티시 트위드 재킷",
      tagline: "플레이리스트 하나로도 찰떡 케미를 찾아냅니다.",
    ...
    jin: {
      ...
      epithet: "불금·심야 매칭 전문",
      outfit: "락 시크 레더 재킷",
      tagline: "밤은 짧고 어색함은 더 짧게. 텐션 맞춰 갑니다.",
  ...
  waiterGallery: {
    ...
    intro:
      "세대·취향·텐션에 각자 특기가 확실한 아홉 명의 라운지 매니저입니다. 오늘 놀고 싶은 방식에 맞춰 한 명을 골라보세요.",
    strengths: "장점",
    specialty: "특징",
  ...
  lobby: {
    ...
    waitersBody: "아홉 명의 매칭 전문가 중 오늘의 호스트를 골라보세요",
    groupNote:
  ...
  closed: {
    ...
    body: "ClubOn은 전 세계 사용자를 위해 연중무휴 24시간 운영됩니다.",
  ...
  match: {
    ...
    videoNotice:
      "합석하면 두 라운지가 화면과 소리를 함께 나눕니다. 카메라와 마이크는 언제든 직접 끌 수 있습니다.",
    recordingNotice:
      "다른 참가자의 영상·음성·개인정보를 캡처, 녹화, 촬영하거나 공유하는 행위는 금지됩니다. 위반 시 영구 이용정지 및 관련 법률에 따른 법적 책임이 따를 수 있습니다.",
  ...
  lounge: {
    ...
    liveSession: "합석 진행 중",
    liveSessionBody: "이미 열려 있는 대화방이 있습니다.",
    enterRoom: "대화방으로 입장",
